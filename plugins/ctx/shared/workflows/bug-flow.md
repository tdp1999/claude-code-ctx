...
- Move investigation to `plans-done/`
- Update progress.md
...
Investigation moved to `plans-done/012-checkout-500-error.md` with status `completed`.
...
- Only move to `plans-done/` when ALL fix tasks complete
